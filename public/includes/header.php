    ...
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/darbuotoju_statistika.php" class="nav-item <?= $current_page === 'darbuotoju_statistika' ? 'active' : '' ?>" data-testid="link-worker-stats">
                    ...
                    <span>Darbuotojų statistika</span>
                </a>
                ...
                <a href="/sync_log.php" class="nav-item <?= $current_page === 'sync_log' ? 'active' : '' ?>" data-testid="link-sync-log">
